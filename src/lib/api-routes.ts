...
export const DASHBOARD_RECENT_ACTIVITY_ROUTE = () =>
  "/api/dashboard/recent-activity";

export const DASHBOARD_FULL_ROUTE = () => "/api/dashboard/full-dashboard";

export const DASHBOARD_SUBSCRIPTIONS_ROUTE = () =>
...
export const CASHBACK_TRANSACTIONS_ROUTE = () =>
  "/api/cashback/admin/transactions";

export const CASHBACK_APPROVE_TRANSACTION_ROUTE = (id: string) =>
  `/api/cashback/admin/transactions/${id}/approve`;

export const CASHBACK_DECLINE_TRANSACTION_ROUTE = (id: string) =>
  `/api/cashback/admin/transactions/${id}/decline`;
...
export const DELETE_MICROCHIPPED_PET_ROUTE = (id: string) =>
  `/api/pet/${id}/microchip`;
...
export const RESCHEDULE_SERVICE_ROUTE = (id: string) =>
  `/api/scheduling/${id}/reagendamento-admin`;

export const DELETE_SCHEDULE_SERVICE_ROUTE = (id: string) =>
  `/api/scheduling/${id}/cancelamento-admin`;

export const PLAN_ADD_SERVICES = (planId: string) =>
  `/api/plans/${planId}/services/add`;

export const PLAN_REMOVE_SERVICES = (planId: string) =>
  `/api/plans/${planId}/services/remove`;
